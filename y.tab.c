...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    EMPLOYEE = 258,                /* EMPLOYEE  */
    ID = 259,                      /* ID  */
    SALARY = 260,                  /* SALARY  */
    LIST = 261,                    /* LIST  */
    PAYROLL_ALL = 262,             /* PAYROLL_ALL  */
    PAYROLL_EMPLOYEE = 263,        /* PAYROLL_EMPLOYEE  */
    SAVE = 264,                    /* SAVE  */
    LOAD = 265,                    /* LOAD  */
    NUMBER = 266,                  /* NUMBER  */
...
#define SALARY 260
#define LIST 261
#define PAYROLL_ALL 262
#define PAYROLL_EMPLOYEE 263
#define SAVE 264
#define LOAD 265
#define NUMBER 266
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EMPLOYEE = 3,                   /* EMPLOYEE  */
  YYSYMBOL_ID = 4,                         /* ID  */
  YYSYMBOL_SALARY = 5,                     /* SALARY  */
  YYSYMBOL_LIST = 6,                       /* LIST  */
  YYSYMBOL_PAYROLL_ALL = 7,                /* PAYROLL_ALL  */
  YYSYMBOL_PAYROLL_EMPLOYEE = 8,           /* PAYROLL_EMPLOYEE  */
  YYSYMBOL_SAVE = 9,                       /* SAVE  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EMPLOYEE", "ID",
  "SALARY", "LIST", "PAYROLL_ALL", "PAYROLL_EMPLOYEE", "SAVE", "LOAD",
  "NUMBER", "IDENTIFIER", "$accept", "input", "command", "employee", YY_NULLPTR
};
...
{
     -12,     0,   -12,   -11,   -12,    -9,    -7,    -1,     1,   -12,
     -12,     8,   -12,    -6,   -12,   -12,     3,   -12,    10,     5,
     -12
};
...
{
       2,    11,    12,     3,    13,    17,     4,     5,     6,     7,
       8,    14,    16,    15,    18,    19,    20
};

static const yytype_int8 yycheck[] =
{
       0,    12,    11,     3,    11,    11,     6,     7,     8,     9,
      10,    12,     4,    12,    11,     5,    11
};
...
#line 1282 "y.tab.c"
  ...
  case 6: /* command: PAYROLL_ALL NUMBER  */
#line 154 "yacc.y"
                         { calculate_payroll_all((yyvsp[0].ival)); }
#line 1288 "y.tab.c"
    break;

  case 7: /* command: PAYROLL_EMPLOYEE NUMBER NUMBER  */
#line 155 "yacc.y"
                                     { calculate_payroll_employee((yyvsp[-1].ival), (yyvsp[0].ival)); }
#line 1294 "y.tab.c"
    break;

  case 8: /* command: SAVE IDENTIFIER  */
#line 156 "yacc.y"
                      { save_employees_to_file((yyvsp[0].sval)); }
#line 1300 "y.tab.c"
    break;

  case 9: /* command: LOAD IDENTIFIER  */
#line 157 "yacc.y"
                      { load_employees_from_file((yyvsp[0].sval)); }
#line 1306 "y.tab.c"
    break;

  case 10: /* employee: EMPLOYEE IDENTIFIER ID NUMBER SALARY NUMBER  */
#line 162 "yacc.y"
    {
        add_employee((yyvsp[-4].sval), (yyvsp[-2].ival), (yyvsp[0].ival));
    }
#line 1314 "y.tab.c"
    break;
